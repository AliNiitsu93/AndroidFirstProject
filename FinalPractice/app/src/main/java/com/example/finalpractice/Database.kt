...
class Database (context: Context): SQLiteOpenHelper(context, "USERDB", null, 1 ) {
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE TABLE RECEIPT(ORDER_ID INTEGER PRIMARY KEY AUTOINCREMENT, TIMESTAMP DATETIME DEFAULT CURRENT_TIMESTAMP, ODATE TEXT, STORE_NAME TEXT)")
        ...
        db?.execSQL("INSERT INTO RECEIPT(ODATE, STORE_NAME) VALUES('11-1-2020', 'Walmart')")
